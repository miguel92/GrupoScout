...
CREATE TABLE COMENTARIO (ID BLOB(30) NOT NULL, TEXTO VARCHAR(255) NOT NULL, EVENTO_ID_EVENTO BIGINT, SOCIO_ID BIGINT, PRIMARY KEY (ID))
...
CREATE TABLE ENTRADA_CALENDARIO (Categoría VARCHAR(50) NOT NULL, Descripción VARCHAR(200) NOT NULL, FECHA DATE NOT NULL, IDSOCIO BIGINT NOT NULL, SOCIO_ID BIGINT, PRIMARY KEY (FECHA, IDSOCIO))
...
CREATE TABLE NOTIFICACION_DOCUMENTO (Estado VARCHAR(10) NOT NULL, ID_DOCUMENTO BIGINT NOT NULL, FECHA DATE NOT NULL, IDSOCIO BIGINT NOT NULL, DOCUMENTO_ID_DOCUMENTO BIGINT, SOCIO_ID BIGINT, PRIMARY KEY (ID_DOCUMENTO, FECHA, IDSOCIO))
